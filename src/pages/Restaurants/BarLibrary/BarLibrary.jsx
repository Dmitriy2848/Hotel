...
import header from "../../../assets/media/restaurants/5.jpg";
import s from "./BarLibrary.module.css";
        ...
        <header className={ nav ? `${ s.header + ' ' + s.scrolled }` : `${ s.header }` } >
            ...
            <div className={s.headerContainer}>
                ...
                <div className={s.headerText}>
                    <h1>Бар библиотека</h1>
                    <p>Уютный интерьер, правильно подобранная винная карта и специально разработанное меню</p>
                </div>
            </div>
        </header>
    )
        ...
        <div>
            ...
            <main className={s.main}>
                ...
                <div className={s.description}>
                    <p>Теперь вы можете отдохнуть, перекусить, выпить чашечку кофе или чего покрепче непосредственно в основном корпусе гостиницы.</p>
                </div>
