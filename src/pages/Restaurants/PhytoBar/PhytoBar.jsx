...
import s from "./PhytoBar.module.css";
        ...
        <header className={ nav ? `${ s.header + ' ' + s.scrolled }` : `${ s.header }` } >
            ...
            <div className={s.headerContainer}>
                ...
                <div className={s.headerText}>
                    ...
                    <p>Выбирайте напитки для вашего здоровья</p>
                </div>
            </div>
        </header>
    )
        ...
        <div>
            ...
            <main className={s.main}>
                ...
                <div className={s.description}>
                    <p>Попробуйте напитки, которые помогут активизировать работу иммунной системы, повысить работоспособность и снять напряжение после физических нагрузок, а внимательный персонал окружит вас заботой </p>
                </div>
