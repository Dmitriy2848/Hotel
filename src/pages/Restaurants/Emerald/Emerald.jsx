...
import s from "./Emerald.module.css";
        ...
        <header className={ nav ? `${ s.header + ' ' + s.scrolled }` : `${ s.header }` } >
            ...
            <div className={s.headerContainer}>
                ...
                <div className={s.headerText}>
                    <h1>Ресторан Эмеральд</h1>
                    <p>Наслаждайтесь видом во время обеда</p>
                </div>
            </div>
        </header>
    )
        ...
        <div>
            ...
            <main className={s.main}>
                ...
                <div className={s.description}>
                    <p>Каждое блюдо – это результат сочетания гастрономических экспериментов и бережного отношения. Основная идея интерьера – создание современной, непринуждённой и спокойной атмосферы, которая будет привлекать своим очарованием и индивидуальным стилем. Панорамные окна ресторана откроют перед вами всю красоту и изящность леса</p>
                </div>
