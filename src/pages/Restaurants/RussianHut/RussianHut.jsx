...
import header from "../../../assets/media/restaurants/4.jpg";
import s from "./RussianHut.module.css";
        ...
        <header className={ nav ? `${ s.header + ' ' + s.scrolled }` : `${ s.header }` } >
            ...
            <div className={s.headerContainer}>
                ...
                <div className={s.headerText}>
                    <h1>Ресторан Русская изба</h1>
                    <p>Насладитесь блюдами русской кухни</p>
                </div>
            </div>
        </header>
    )
        ...
        <div>
            ...
            <main className={s.main}>
                ...
                <div className={s.description}>
                    <p>Какой предмет интерьера может стать символом русской кухни? Русская печь. В нашей избе она занимает особое место, наполняя его неповторимой индивидуальностью, создавая теплую атмосферу загородной жизни</p>
                </div>
